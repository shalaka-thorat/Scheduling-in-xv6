  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  1b:	51                   	push   %ecx
  1c:	ff 33                	push   (%ebx)
  1e:	68 fe 07 00 00       	push   $0x7fe
  23:	6a 01                	push   $0x1
  25:	e8 a6 04 00 00       	call   4d0 <printf>
        exit();
  2a:	e8 24 03 00 00       	call   353 <exit>
    }
  ...
  36:	e8 58 03 00 00       	call   393 <open>
    if (fd < 0) {
  ...
  50:	e8 26 03 00 00       	call   37b <close>

    exit();
  55:	e8 f9 02 00 00       	call   353 <exit>
        printf(1, "Error opening file %s\n", argv[1]);
  5a:	50                   	push   %eax
  ...
  65:	e8 66 04 00 00       	call   4d0 <printf>
        exit();
  6a:	e8 e4 02 00 00       	call   353 <exit>
  6f:	90                   	nop
...
00000070 <ping_pong>:
{
  ...
  83:	68 00 02 00 00       	push   $0x200
  88:	68 80 0b 00 00       	push   $0xb80
  8d:	56                   	push   %esi
  8e:	e8 d8 02 00 00       	call   36b <read>
  93:	83 c4 10             	add    $0x10,%esp
  96:	85 c0                	test   %eax,%eax
  98:	7e 56                	jle    f0 <ping_pong+0x80>
      for(i=0; i<n; i++)
  9a:	31 db                	xor    %ebx,%ebx
  9c:	eb 08                	jmp    a6 <ping_pong+0x36>
  9e:	66 90                	xchg   %ax,%ax
  a0:	39 c2                	cmp    %eax,%edx
  a2:	7d dc                	jge    80 <ping_pong+0x10>
  a4:	89 d3                	mov    %edx,%ebx
         if('p' == buf[i])
  a6:	80 bb 80 0b 00 00 70 	cmpb   $0x70,0xb80(%ebx)
            if('i' == buf[i+1])
  ad:	8d 53 01             	lea    0x1(%ebx),%edx
         if('p' == buf[i])
  b0:	75 ee                	jne    a0 <ping_pong+0x30>
            if('i' == buf[i+1])
  b2:	80 ba 80 0b 00 00 69 	cmpb   $0x69,0xb80(%edx)
  b9:	75 e5                	jne    a0 <ping_pong+0x30>
               if('n' == buf[i+2])
  bb:	80 bb 82 0b 00 00 6e 	cmpb   $0x6e,0xb82(%ebx)
  c2:	75 dc                	jne    a0 <ping_pong+0x30>
                  if('g' == buf[i+3])
  c4:	80 bb 83 0b 00 00 67 	cmpb   $0x67,0xb83(%ebx)
  cb:	75 d3                	jne    a0 <ping_pong+0x30>
                     printf(1, "pong\n");
  cd:	83 ec 08             	sub    $0x8,%esp
  d0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  d3:	68 f8 07 00 00       	push   $0x7f8
  d8:	6a 01                	push   $0x1
  da:	e8 f1 03 00 00       	call   4d0 <printf>
      for(i=0; i<n; i++)
  df:	8b 45 f4             	mov    -0xc(%ebp),%eax
  e2:	8d 53 04             	lea    0x4(%ebx),%edx
  e5:	83 c4 10             	add    $0x10,%esp
  e8:	eb b6                	jmp    a0 <ping_pong+0x30>
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 2d 08 00 00       	mov    $0x82d,%edx
        while(*s != 0){
